...
# (layer 1) is installed with `just install-nixos` and updated with `just deploy`.
#
...
output "portal_ipv4" {
  ...
  description = "Static IPv4 of portal - install with: just install-nixos portal root@<this>"
}
