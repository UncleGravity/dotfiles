...
-- Move these function declarations before they are used
local function positionDropterm(window)
...
local function launchKittyWithSession()
    if kittyPath ~= "" then
